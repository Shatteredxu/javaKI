...
5. treeifyBin的链表转红黑树操作，代表中有写，注意转换条件
...
/**
    ...
    final Node<K,V>[] resize() {
        ...
        if (oldTab != null) {//第一次初始化的时候扩容不走if，第二次数组中有元素才走if
